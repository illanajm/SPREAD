 ...
 <div class="page">
  <span class="menu_toggle">
   ...
   <main class="content">
	...
	<form method="POST" action="insert_subject_number.php">
		
		<div class="form-group">
					<label style="padding-right: 168px;color: white">Subject Code:</label>
					<input style="background-color: lightgray;opacity: 1;"  type="text" class="form-control" id="subject_code" name="subject_code" placeholder="Subject Code">
					<label style="padding-right: 168px;color: white">Subject Name:</label>
					<input style="background-color: lightgray;opacity: 1;"  type="text" class="form-control" id="subject_name" name="subject_name" placeholder="Subject Name">
					<label style="padding-right: 168px;color: white">Mobile #:</label>
					<input style="background-color: lightgray;opacity: 1;"  type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile #">
					</div>

					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<button id="boton" name="submit" type="submit" id="boton" class="login100-form-btn">
								Submit
							</button>
						</div>
					</div> 
...
<script src="insert_subject_numbers.js"></script>
